...
import com.typewritermc.engine.paper.utils.runAtLocation
...
class PFInstanceSpace(val world: com.typewritermc.core.utils.point.World) : IInstanceSpace {
    ...
    override fun columnarSpaceAt(cx: Int, cz: Int): PFColumnarSpace {
        ...
        val location = org.bukkit.Location(bukkitWorld, (cx * 16).toDouble(), 64.0, (cz * 16).toDouble())

        val snapshot = runAtLocationForResult(location) {
            bukkitWorld.getChunkAt(cx, cz).getChunkSnapshot(false, false, false)
        }.get()
