...
val Dispatchers.Sync: CoroutineDispatcher
    get() = if (FoliaSupported.isFolia) FoliaSyncDispatcher else PaperDispatchers.Sync

val Dispatchers.TickedAsync: CoroutineDispatcher
    get() = if (FoliaSupported.isFolia) FoliaAsyncDispatcher else PaperDispatchers.TickedAsync
